...
import { AppointmentRequest, AppointmentResponse, AppointmentStatus ,AppointmentSummary } from '../models/appointment.model';
...
export class AppointmentService {
  ...
  size: number,
  sort?: string
): Observable<PageResponse<AppointmentSummary>> {
  ...
  return this.http.get<PageResponse<AppointmentSummary>>(this.baseUrl, { params });
}
